...
//          index:         0        1        2        3        4
var fruits = ["Apple", "Banana", "Mango", "Peach", "Cherry"];
var index = fruits.indexOf("Banana"); // returns the index of banana 
console.log("Index of Banana", index); //print "Index of Banana" = 1
var index1 = fruits.indexOf("Kiwi"); //  returns the index of kiwi 
